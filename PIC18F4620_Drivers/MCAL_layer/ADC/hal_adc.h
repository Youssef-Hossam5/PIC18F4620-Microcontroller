 ...
 * Author: lenovo
 *
 * Created on July 21, 2024, 5:40 PM
 */
...
typedef struct{
    ...
    void (* ADC_InterruptHandler)(void); /* pointer to function if there is a call back function in app layer */
 ...
 */
typedef uint16 adc_result_t; /* The ADC result is 16 bits */
