...
# 13 "MCAL_layer/CCP/../mcal_std_types.h"
...
static void CCP_PWM_Mode_Config(const ccp_t *_ccp_obj){
    ...
    PR2 = (uint8)(((float)4000000 / ((float)_ccp_obj->PWM_Frequency * 4.0 * (float)_ccp_obj->timer2_prescaler_value *
